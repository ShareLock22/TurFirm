...
constexpr auto qt_meta_stringdata_CLASSWindowNavigatorENDCLASS = QtMocHelpers::stringData(
    "WindowNavigator",
    "onUserEntered",
    "",
    "Actor::Role",
...
void WindowNavigator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onUserEntered((*reinterpret_cast< std::add_pointer_t<Actor::Role>>(_a[1]))); break;
